# <img src="public/logo.svg" width="32" height="32" valign="middle" /> TruthLens

> **AI-Powered Information Clarity.** Transform the way you process, analyze, and understand text with precision.

TruthLens is a modern, intelligent data processing platform designed to extract deep insights from text and images. Whether it's detecting emotional undertones, identifying hidden biases, or generating objective rewrites, TruthLens provides the tools you need to see through the noise.
...
Powered by Tesseract.js, TruthLens can extract text from images and documents, bringing intelligent analysis to non-selectable content.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/rajaryan2007/truthlens.git
   cd truthlens
   ```
...
The TruthLens extension allows you to analyze text directly from any website.
...
5. Pin TruthLens to your toolbar for easy access!
