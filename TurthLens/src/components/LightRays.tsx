...
const LightRays: React.FC<LightRaysProps> = ({
  ...
  useEffect(() => {
    ...
    const initializeWebGL = () => {
      ...
      // Ensure previous cleanup runs first
...
void main() {
  ...
  gl_FragColor  = color;
      ...
      const updatePlacement = () => {
        if (!isComponentMounted || !containerRef.current || !rendererRef.current) return;
      ...
      const loop = (t: number) => {
        if (!isComponentMounted || !rendererRef.current || !uniformsRef.current || !meshRef.current) {
          return;
        }
